...
def function():
    ...
    st.title('Stocker')
    st.write('##')
    st.write('Web app predicting future stock closing prices with artificial intelligence')
    ...
    with column2:
        ...
        st.write('##')
        date1 = st.text_input('From what date will the data be fetched?', '2020-01-01')
        st.write('##')
        st.write('Remarks:')
    ...
    with column3:
        ...
        st.write('##')
        date3 = st.text_input('Until what date will the closing price will be predicted?', '2023-12-31')
        st.write('##')
        st.write('Remarks:')
